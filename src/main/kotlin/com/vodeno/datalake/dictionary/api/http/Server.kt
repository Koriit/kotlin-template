package com.vodeno.datalake.dictionary.api.http

import com.fasterxml.jackson.core.JsonProcessingException
import com.uchuhimo.konf.Config
import com.vodeno.datalake.dictionary.api.http.configuration.HttpApiConfig
import com.vodeno.datalake.dictionary.api.http.configuration.HttpApiConfig.host
import com.vodeno.datalake.dictionary.api.http.configuration.HttpApiConfig.logPayloads
import com.vodeno.datalake.dictionary.api.http.configuration.HttpApiConfig.port
import com.vodeno.datalake.dictionary.api.http.configuration.HttpApiConfig.scheme
import com.vodeno.datalake.dictionary.api.http.configuration.LogstashLogging
import com.vodeno.datalake.dictionary.api.http.controllers.appVersionController
import com.vodeno.datalake.dictionary.api.http.controllers.entitiesController
...
fun DKodein.serverConfig() = applicationEngineEnvironment {
    ...
    log = com.vodeno.datalake.dictionary.api.http.log
